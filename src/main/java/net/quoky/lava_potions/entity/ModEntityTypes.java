...
public class ModEntityTypes {
    ...
    public static final DeferredRegister<EntityType<?>> ENTITY_TYPES = 
            DeferredRegister.create(ForgeRegistries.ENTITY_TYPES, Lava_Potions.MOD_ID);
    
    // Register the thrown lava potion entity
    public static final RegistryObject<EntityType<ThrownLavaPotion>> THROWN_LAVA_POTION = 
            ENTITY_TYPES.register("thrown_lava_potion", 
